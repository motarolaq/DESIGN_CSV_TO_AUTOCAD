...
file = pd.read_csv(r"(02)-DE_B-830_TRAMOLP14_PREC_REPL.csv")

# 4. DEBE CONSIDERAR QUE EL ARCHIVO TENGA COMO NOMBRE DE ENCABEZADO: HOLEID|NORTE|ESTE|PISO (SIRVE PARA LOS FORMATOS CSV (2) EN SMARTSHEET).
...
# SI VA A LEER LOS FORMATOS (2) .CSV EN SMARTSHEET, DEBERÁ GUARDAR LAS COORDENADAS NORTE, ESTE, PISO INCLUYENDO SU ENCABEZADO EN UNA NUEVA HOJA
# UNA VEZ QUE TENGA LOS DATOS FILTRADOS, GUARDE ESA HOJA EN FORMATO CSV UTF-8 DELIMITADO POR COMAS EN LA CARPETA "CSV TO AUTOCAD".
# LUEGO, ABRA EL PROGRAMA EN VISUAL STUDIO CODE Y ESCRIBA EL NOMBRE DEL ARCHIVO EN "file", Y SIGA EL PROCEDIMIENTO COMO SALE EN LAS INSTRUCCIONES.
